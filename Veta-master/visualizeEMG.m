...
% Last Modified by GUIDE v2.5 10-Jun-2021 15:34:56
...
% commenting our artifact channel
...
%changed n to 4 so it doesnt try plot channels 5 and 6
for n=1:4 %subplot_number
...
%     end
    ...
    % commenting out more artifact variables
%     %add TMS artefact
...
%     end    
    ...
    button_width = .04;
    button_height = .04;
 %commenting our more artifact variables   
...
% --- Executes on button press in ch5_burst.
function ch5_burst_Callback(hObject, eventdata, handles)
% hObject    handle to ch5_burst (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)


% --- Executes on button press in ch5_MEP.
function ch5_MEP_Callback(hObject, eventdata, handles)
% hObject    handle to ch5_MEP (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)


% --- Executes on button press in ch5_TMS_art.
function ch5_TMS_art_Callback(hObject, eventdata, handles)
% hObject    handle to ch5_TMS_art (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)


% --- Executes on button press in ch5_clearEMG.
function ch5_clearEMG_Callback(hObject, eventdata, handles)
% hObject    handle to ch5_clearEMG (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)


% --- Executes on button press in ch5_clearMEP.
function ch5_clearMEP_Callback(hObject, eventdata, handles)
% hObject    handle to ch5_clearMEP (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)


% --- Executes on button press in ch5_CSP.
function ch5_CSP_Callback(hObject, eventdata, handles)
% hObject    handle to ch5_CSP (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)


% --- Executes on button press in ch5_clearCSP.
function ch5_clearCSP_Callback(hObject, eventdata, handles)
% hObject    handle to ch5_clearCSP (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)


% --- Executes on button press in ch5_clearTMSart.
function ch5_clearTMSart_Callback(hObject, eventdata, handles)
% hObject    handle to ch5_clearTMSart (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
